 ...
 * `gettext()` simplement tradueix un `msgid` al seu corresponent `msgstr` per a un idioma determinat. També existeix la funció curta `_()` que funciona de la mateixa manera;
